...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="bg-warning">
         <div class="alert alert-light alert-dismissible fade show" role="alert" align="center">
            <p>You have to be logged in to make changes to the database! You can do that from the menu.</p>
       ...
       echo $proc1->transformToXml($xmlDoc1);
        ...
        <div class="alert alert-light" role="alert">
            <a href="#" style="pointer-events: none;"> Add new item</a>
        </div>
        <?php
